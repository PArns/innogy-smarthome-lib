...
SmartHome.prototype._startRealtimeUpdates = function () {
    ...
    var createWebSocket = function(status) {
        ...
        if (that._requestor._config.oAuth2Credentials &&
            ...
            webSocketUri = 'ws://' + that._requestor._config.baseConfig.apiHost + ":9090" + that._requestor._config.baseConfig.versionPrefix + 'events?token=' + encodeURIComponent(status.token.access_token);
