...
SmartHome.prototype.startAuthorization = async function (callback) {
    if (this._authServer) {
        await new Promise(resolve => this._authServer.close(() => resolve()));
        this._authServer = null;
    }
                                ...
                                return that._messages().then(function () {
                                    ...
                                    setTimeout(function () {
                                        that._startRealtimeUpdates().then(function () {
                                            that._receivedMessages.forEach(function (aMessage) {
