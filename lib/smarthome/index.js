...
SmartHome.prototype.getAuthorizationUri = function () {
    return this._requestor._oAuth2.getAuthorizationStartUri(this._requestor._config.oAuth2Credentials.oAuth2RedirectConfig.port || 3000);
};

SmartHome.prototype.startAuthorization = function (callback) {
    if (!this._authRunning) {
        var res = this._requestor._oAuth2.startAuthorization(this._requestor._config.oAuth2Credentials.oAuth2RedirectConfig.port || 3000, callback);
...
SmartHome.prototype._messages = function (callback) {
    var that = this;
    var parser = [];
